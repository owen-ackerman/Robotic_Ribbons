...
class RobotEXT:
	...
	def __init__(self, ownerComp):
		...
		self.max_phi = 135.0
		self.min_phi = -135.0
		self.max_theta_velocity = 200.0  # degrees/sec
		self.max_phi_velocity = 100.0  # degrees/sec
		self.max_theta_acceleration = 10.0  # degrees/sec^2
		self.max_phi_acceleration = 50.0  # degrees/sec^2
	...
	def PushToCHOP(self):
		...
		chop.par.const2value = pulse_per_sec + 100000 
		#add offset for sending via serial to arduino
